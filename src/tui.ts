...
export class Tui {
  ...
  private applyLayout(): void {
    const totalWidth = typeof this.screen.width === "number" ? this.screen.width : this.screen.cols;
    const sidebarWidth = Math.min(this.sidebarWidth, Math.max(totalWidth - 10, 1));
